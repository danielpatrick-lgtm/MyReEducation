          ...
          {REELS.map((r, i) => (
            <div className="reel" key={i}>
              <div className="reel-bg" style={{
                background: `radial-gradient(70% 50% at 50% 35%, oklch(0.55 0.14 ${r.hue}) 0%, oklch(0.16 0.04 ${r.hue}) 65%, #0b0b0c 100%)`
              }}>
                <div style={{
              ...
              <div style={{position:'absolute', top:10, right:10, zIndex:2, background:'rgba(0,0,0,0.5)', backdropFilter:'blur(8px)', borderRadius:6, padding:'3px 6px', fontSize:9, letterSpacing:'.1em', color:'var(--warm-white)'}}>
                {i % 2 === 0 ? 'REEL' : 'STORY'}
              </div>
